...
const required = [
  'README.md','LICENSE','SECURITY.md','PRIVACY.md','USAGE_POLICY.md',
  'BRAND_AND_IDENTITY.md','CONTRIBUTING.md','THIRD_PARTY_NOTICES.md',
...
for (const file of required) {
  try { if (!(await stat(file)).isFile()) failures.push(`missing required file: ${file}`); }
...
console.log(`release audit ok: ${files.length} tracked files, no GitHub Actions, no private runtime paths or known secret patterns`);
